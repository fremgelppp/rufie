...
enemy1 = Enemy('enemy.png', win_width - 100, 200, 80, 80, 4)
enemy2 = Enemy('enemy.png', win_width - 100, 100, 80, 80, 3)
#добавляем врагов в группу
enemys.add(enemy1)
enemys.add(enemy2)
 
final_sprite = GameSprite('Win.png', win_width - 100, win_height - 80, 80, 80)
